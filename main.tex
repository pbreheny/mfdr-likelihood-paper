...
These approaches, however, suffer from two primary drawbacks.  First, they are very restrictive, in the sense that they are often unable to select more than one or two features, even at high false discovery rates.  This is especially true in high dimensions.  Second, they are quite computationally intensive.  For both approaches, it typically takes several orders of magnitude longer to estimate the false discovery rate than to fit the model in first place.
...
\begin{table}[htb!]
\centering
\caption{\label{Tab:shedden} Results comparing different $\lambda$ choices, along the default sequence generated by {\tt ncvreg}, using the lasso and MCP penalties on the Shedden and Spira data}
\vspace{.2cm}
\begin{tabular}{l r r r r r r }
 Shedden Case Study & & & & & & \\
  \hline
lasso & $\lambda$ & EF & S & mFDR & cross validation error & misclassification error  \\ 
	\hline
	CV & 0.1215 & 9.16 & 13 & 70.4\% & 1307.9 & -  \\
	CV(1se) & 0.180  &  0 &  0 &  -  & 1320.2 & -  \\
	mFDR & 0.146 & 0.52 & 8 & 6.6\% & 1313.3 &  - \\
\hline
MCP & $\lambda$ & EF & S & mFDR  & cross validation error & misclassification error  \\
	\hline
...
lasso & $\lambda$ & EF & S & mFDR & cross validation error & misclassification error  \\ 
	\hline
	CV & 0.0294 & 49 & 49 & 100\% & 0.995 & 24.5\%  \\
	CV(1se) & 0.0627 & 32 & 32 & 100\% & 1.074 & 25.0\%  \\
	mFDR & 0.146 & 0.785 & 10 & 7.8\% & 1.289 & 30.7\% \\
\hline
MCP & $\lambda$ & EF & S & mFDR & cross validation error & misclassification error  \\
	\hline
	CV & 0.0775 & 13 & 13 & 100\% & 1.113 & 30.2\% \\
	CV(1se) & 0.0929 & 10 & 10 & 100\% & 1.182 & 33.3\%  \\
	mFDR & 0.1508 & 0.42 & 5 & 8.4\% & 1.306 & 33.9\% \\
		\hline
\end{tabular}
\end{table}
...
Furthermore, mFDR is far more convenient from the standpoint of computational burden than other approaches. For the Spira data, where $n = 192$ and $p =22215$, using {\tt ncvreg} to fit a penalized logistic regression model and then estimating the mFDR for the entire $\lam$ sequence takes only 1.4 seconds.  This is over 400 times faster than sample splitting and CovTest, which take 568 and 571 seconds respectively, and is nearly 30 times faster than even univariate testing which takes 232 seconds.
